...
close
ncfile = {...
'HN_Cal_2013_2016_3D_wq_Impact_v2_WQ.nc',...
'HN_Cal_2013_2016_3D_wq_Baseline_v2_WQ.nc',...
'HN_Cal_2013_2016_3D_wq_Background_v2_WQ.nc',...
};
% ------------------- User Input ------------------
...
%cd(WorkDir);
	...
	for iFiles = 1:NumFiles
		...
		ResFile = ncfile{bb};
		ResPath = '/Projects2/Cattai/HN_CC_Cal_v1_A8_Scenarios/output/'
