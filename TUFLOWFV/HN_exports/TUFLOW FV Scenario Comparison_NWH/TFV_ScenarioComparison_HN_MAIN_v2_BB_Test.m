...
ScriptDir = 'C:\Users\00065525\AED Dropbox\Scratch\Hawkesbury\Cattai\Matlab\MatlabScriptsToUWA\TUFLOW FV Scenario Comparison_NWH\';
cd(ScriptDir);
addpath(genpath(ScriptDir));

% Parent Directory where all necessary TUFLOW MATLAB scripts are, such as
% netcdf_get_var
SupportingScriptsDir = 'C:\Users\00065525\AED Dropbox\Scratch\Hawkesbury\Cattai\Matlab\MatlabScriptsToUWA\TUFLOW FV MATLAB utilities\';
addpath(genpath(SupportingScriptsDir));

ScnUIindexFiles = {'Index_HN_Test_BB.csv';...
    };
...
for iScnIdx = 1%:18
    sprintf('Running Scenario set %d of 1',iScnIdx)
