%% TFV Scenario Comparison North Richmond WQ analysis %%

% Derived from TFV_ScenarioComparison_HN_MAIN_V2.m. Used to extract analyse
% and plot HN EIS Scenario results for North Richmond WQ analysis
% Kaushal Kumandur
% R2021a
clear
close all
...
ScnUIindexFiles = {'Index_Scn02_Scn01_Scn00_DRY_NthRichmond.csv'};

isZoomFlow = 0;
isZoomLong = 0;

for iScnIdx = 1:size(ScnUIindexFiles,1)
    sprintf('Running Scenario set %d of %d',iScnIdx,size(ScnUIindexFiles,1))
