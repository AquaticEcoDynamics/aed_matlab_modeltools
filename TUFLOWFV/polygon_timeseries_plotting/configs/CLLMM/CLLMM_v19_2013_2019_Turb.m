...
def.cAxis(20).value = [0 1];%'OP',...
def.cAxis(21).value = [0 100];%'NCS SS1',...
...
outputdirectory = 'F:\Cloudstor\Shared\Aquatic Ecodynamics (AED)\AED_Lowerlakes\Project Results\CEWH 2019\2013_2019_AED_Narrung_Reporting_Sites_Wind\Regions\';
% ____________________________________________________________Configuration
