...
polygon_file = 'GIS/CLLMM/River_Sites.shp';
...
outputdirectory = 'K:\Lowerlakes-CEW-Results\Regions H\';
% ____________________________________________________________Configuration

% Models___________________________________________________________________


 ncfile(1).name = 'K:\Lowerlakes-CEW-Results\Processed_v2\lower_lakes\';
 ncfile(1).symbol = {'-';'--'};
 ncfile(1).colour = {'b','b'}; % Surface and Bottom
 ncfile(1).legend = 'Obs';
 ncfile(1).translate = 1;
%  
 ncfile(2).name = 'K:\Lowerlakes-CEW-Results\Processed_v2\lower_lakes_noCEW\';
 ncfile(2).symbol = {'-';'--'};
 ncfile(2).colour = {'r','r'}; % Surface and Bottom
 ncfile(2).legend = 'No CEW';
 ncfile(2).translate = 1;
 
 ncfile(3).name = 'K:\Lowerlakes-CEW-Results\Processed_v2\lower_lakes_noEWater\';
 ncfile(3).symbol = {'-';'--'};
