...
def.cAxis(2).value = [10 35];    %'TEMP',...
def.cAxis(3).value = [-1 2];    %'H',...
...
outputdirectory = 'F:\Cloudstor\Shared\Aquatic Ecodynamics (AED)\AED_Lowerlakes\Project Results\CEWH 2019\2013_2019_test_Narrung_Wind_Mouth v2\Regions\';
% ____________________________________________________________Configuration

% Models___________________________________________________________________


 ncfile(1).name = 'K:\v001_CEW_2013_2019_v1\Output\Bak\lower_lakes_old_Wind.nc';
 ncfile(1).symbol = {'-';'--'};
...
%  
 ncfile(2).name = 'K:\v001_CEW_2013_2019_v1\Output\lower_lakes.nc';
 ncfile(2).symbol = {'-';'--'};
 ncfile(2).colour = {'r','r'}; % Surface and Bottom
 ncfile(2).legend = 'NCEP';
