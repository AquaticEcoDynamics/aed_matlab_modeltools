...
outputdirectory = '/Projects2/Cattai/cattai_tfv_aed_v2/Plots/Timeseries/2013/RAW/';
htmloutput = ['/Projects2/Cattai/cattai_tfv_aed_v2/Plots/Timeseries/2013/HTML/'];

% ____________________________________________________________Configuration

% Models___________________________________________________________________

 ncfile(1).name = '/Projects2/Cattai/cattai_tfv_aed_v2/output/CC_Cal_2013_2014_2.nc';
...
%  
  ncfile(2).name = '/Projects2/Cattai/cattai_tfv_aed_v2/output/CC_Cal_2013_2014_2_2036.nc'; 
  ncfile(2).symbol = {'-';'--'};
