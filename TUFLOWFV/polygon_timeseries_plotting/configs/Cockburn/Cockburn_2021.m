...
polygon_file = '/Projects2/Jayden/Cockburn_v1_2018/Matlab/gis/Cockburn_Sites.shp';
...
plotdepth = {'surfacce'; 'bottom'};%'bottom'};%;'bottom'};%'bottom'}; % Cell with either one or both
...
outputdirectory = '/Projects2/Jayden/Cockburn_2021_2022/Plots/Polygon/RAW/';
htmloutput = ['/Projects2/Jayden/Cockburn_2021_2022/Plots/Polygon/HTML/'];

% ____________________________________________________________Configuration

% Models___________________________________________________________________

 ncfile(1).name = '/Projects2/Jayden/Cockburn_2021_2022/Output/Cockburn_2021_2022_ALL.nc';
