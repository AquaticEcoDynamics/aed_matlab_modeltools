...
yr = 2017;
def.datearray = datenum(yr,7,1:5:36);

%outputdirectory = './Timeseries_Basecase_June/RAW/';
%htmloutput = './Timeseries_Basecase_June/HTML/';
outputdirectory = 'C:\Users\00065525\Scratch\Testing\Images\WINBIN/RAW/';
htmloutput = 'C:\Users\00065525\Scratch\Testing\Images\WINBIN/HTML/';
% ____________________________________________________________Configuration
...
% Models___________________________________________________________________
 ncfile(1).name = 'C:\Users\00065525\Scratch\Testing\simulation\coorong-bgc-master-20210414_windows_test\coorong-bgc-master\02_modelling\output\CoorongBGC_006_validation_201707_201903_wq_all.nc';
 ncfile(1).symbol = {'-';'--'};
 ncfile(1).colour = {[140,81,10]./255,[216,179,101]./255};% Surface and Bottom % Surface and Bottom
 ncfile(1).legend = 'WIN TEST';
 ncfile(1).translate = 1;
% 
 ncfile(2).name = 'C:\Users\00065525\Scratch\Testing\basecase\CoorongBGC_006_validation_201707_201903_wq_all.nc';
 ncfile(2).symbol = {'-';'--'};
