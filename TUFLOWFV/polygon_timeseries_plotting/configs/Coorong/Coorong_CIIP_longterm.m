...
%fielddata_matfile = 'C:\Users\00064235\CWorkFolder\github\CDM\scripts\matlab\dataimport\UA.mat';
%fielddata = 'UA';
%fielddata_matfile = 'lowerlakes.mat';
%fielddata = 'lowerlakes';
...
yr = 2013;
def.datearray = datenum(yr,3:12:77,1);

%outputdirectory = './Timeseries_Basecase_June/RAW/';
%htmloutput = './Timeseries_Basecase_June/HTML/';
outputdirectory = './CIIP/longterm2/RAW/';
htmloutput = './CIIP/longterm2/HTML/';
% ____________________________________________________________Configuration
...
% Models___________________________________________________________________
 ncfile(1).name = 'E:\database\Lowerlakes_CEW\Plottfv_polygon\CIIP\CoorongBGC_005_calibration_201305_201903_wq_all.nc';
 ncfile(1).symbol = {'-';'--'};
 ncfile(1).colour = {[213,62,79]./255,[216,179,101]./255};% Surface and Bottom % Surface and Bottom
 ncfile(1).legend = '2013 - 2019';
