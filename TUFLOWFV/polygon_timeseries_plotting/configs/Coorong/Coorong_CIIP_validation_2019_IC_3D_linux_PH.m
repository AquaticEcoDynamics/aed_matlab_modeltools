...
outputdirectory = '/Projects2/CDM/hchb_tfvaed_v1_resuspension/plots/SEDGRAB4/RAW/';
htmloutput = '/Projects2/CDM/hchb_tfvaed_v1_resuspension/plots/SEDGRAB4/HTML/';
% ____________________________________________________________Configuration
...
% Models___________________________________________________________________
 ncfile(1).name = '/Projects2/CDM/hchb_tfvaed_v1_resuspension/output_resuspension_test2/hchb_wave_21901101_20210701_wq_v5_resuspension_all.nc';
 ncfile(1).symbol = {'-';'--'};
 ncfile(1).colour = {[140,81,10]./255,[216,179,101]./255};% Surface and Bottom % Surface and Bottom
 ncfile(1).legend = 'ori';
 ncfile(1).translate = 1;
% 
 ncfile(2).name = '/Projects2/CDM/hchb_tfvaed_v1_resuspension/output_sedIC4_noWave/hchb_wave_21901101_20210701_wq_v5_Noresuspension_all.nc';
 ncfile(2).symbol = {'-';'--'};
 ncfile(2).colour = {[252,141,89]./255,[1,102,94]./255}; % Surface and Bottom
 ncfile(2).legend = 'no Wave';
 ncfile(2).translate = 1;

 ncfile(3).name = '/Projects2/CDM/hchb_tfvaed_v1_resuspension/output_sedIC4/hchb_wave_21901101_20210701_wq_v5_resuspension_sedIC_all.nc';
 ncfile(3).symbol = {'-';'--'};
 ncfile(3).colour = {[230,245,152]./255,[1,102,94]./255}; % Surface and Bottom
 ncfile(3).legend = 'SED GRAB';
