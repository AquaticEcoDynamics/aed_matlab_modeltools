...
% Models___________________________________________________________________
 ncfile(1).name = 'W:\CIIP\Scenarios\Calibration\2017_2019\CoorongBGC_006_validation_201707_201903_wq_all.nc';
 ncfile(1).symbol = {'-';'--'};
 ncfile(1).colour = {[140,81,10]./255,[216,179,101]./255};% Surface and Bottom % Surface and Bottom
 ncfile(1).legend = '2017 - 2019';
 ncfile(1).translate = 1;
% 
 ncfile(2).name = 'Y:\CDM\Wave\coorong-bgc-master-20210414\coorong-bgc-master\02_modelling\output\CoorongBGC_006_validation_201707_201903_wq_wave_all.nc';
 ncfile(2).symbol = {'-';'--'};
