...
yr = 2017;
def.datearray = datenum(yr,7,1:5:30);

%outputdirectory = './Timeseries_Basecase_June/RAW/';
%htmloutput = './Timeseries_Basecase_June/HTML/';
outputdirectory = 'C:\Users\00065525\Scratch\CDM\wave_test\RAW\';
htmloutput = 'C:\Users\00065525\Scratch\CDM\wave_test\HTML\';
% ____________________________________________________________Configuration
...
% 
 ncfile(2).name = 'Y:\CDM\Wave\coorong-bgc-master-20210414\coorong-bgc-master\02_modelling\output\CoorongBGC_006_validation_201707_201903_wq_wave_resus_all.nc';
 ncfile(2).symbol = {'-';'--'};
 ncfile(2).colour = {[252,141,89]./255,[1,102,94]./255}; % Surface and Bottom
 ncfile(2).legend = 'tau_r';
