...
outputdirectory = '/Projects2/CDM/MER_Coorong_eWater_2021_final/plots/Comparison_VH/RAW/';
htmloutput = '/Projects2/CDM/MER_Coorong_eWater_2021_final/plots/Comparison_VH/HTML/';
% ____________________________________________________________Configuration
...
% 
 ncfile(1).name = '/Projects2/CDM/MER_Coorong_eWater_2021_final/output_basecase_BK/eWater2021_basecase_all.nc';
 ncfile(1).symbol = {'-';'--'};
 ncfile(1).colour = {[117,112,179]./255,[117,112,179]./255}; % Surface and Bottom
 ncfile(1).legend = 'V2-BK';
 ncfile(1).translate = 1;
 
 ncfile(2).name = '/Projects2/CDM/MER_Coorong_eWater_2021/output_basecase/eWater2021_basecase_all.nc';
 ncfile(2).symbol = {'-';'--'};
 ncfile(2).colour = {[27,158,119]./255,[27,158,119]./255}; % Surface and Bottom
 ncfile(2).legend = 'V1';
 ncfile(2).translate = 1;

 ncfile(3).name = '/Projects2/CDM/MER_Coorong_eWater_2021_final/output_basecase_VH/eWater2021_basecase_all.nc';
 ncfile(3).symbol = {'-';'--'};
 ncfile(3).colour = {[217,95,2]./255,[217,95,2]./255}; % Surface and Bottom
 ncfile(3).legend = 'V2-VH';
 ncfile(3).translate = 1;
% % 
 ncfile(4).name = '/Projects2/CDM/MER_Coorong_eWater_2021_final/output_basecase_VH_noOS/eWater2021_basecase_all.nc';
 ncfile(4).symbol = {'-';'--'};
 ncfile(4).colour = {[231,41,138]./255,[231,41,138]./255}; % Surface and Bottom
 ncfile(4).legend = 'V2-VHnoOS';
