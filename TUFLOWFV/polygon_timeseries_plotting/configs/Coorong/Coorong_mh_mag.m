...
outputdirectory = '/AED/Development/matt/hchb_tfvaed_v3_2022_4PFTs_SedZone_sdg/plots31_MAG_eWater_15June_b/RAW/';
htmloutput = '/AED/Development/matt/hchb_tfvaed_v3_2022_4PFTs_SedZone_sdg/plots31_MAG_eWater_15June_b/HTML/';
% ____________________________________________________________Configuration
...
% Models___________________________________________________________________
 ...
 ncfile(1).name = '/Scratch/output_basecase_hd/eWater2021_basecase_t3_all.nc';
 ncfile(1).symbol = {'-';'--'};
 ncfile(1).colour = {[106,61,154]./255,[106,61,154]./255}; % Surface and Bottom
 ncfile(1).legend = 'mag14';
 ncfile(1).translate = 1;

 ncfile(2).name = '/Scratch/MER_Coorong_eWater_2022_GEN20/output_basecase_hd/eWater2021_basecase_t3_all.nc';
 ncfile(2).symbol = {'-';'--'};
