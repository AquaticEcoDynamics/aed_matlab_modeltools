...
sites = [1:30];  % Sites in shapefile (polygon IDs) to plot
...
yr = 2017;
def.datearray = datenum(yr,7:6:55,1); %55
...
ncfile(2).name = '/Scratch/MER_Coorong_eWater_GEN20/output_basecase_22d/eWater2021_basecase_all.nc';
ncfile(2).symbol = {'-';'--'};
