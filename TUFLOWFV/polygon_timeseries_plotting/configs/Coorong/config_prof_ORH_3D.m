...
def.cAxis(5).value = [0 5]; 	%'WQ_DIAG_TOT_TURBIDITY',...
...
outputdirectory = 'F:\Cloudstor\Shared\Aquatic Ecodynamics (AED)\AED_Lowerlakes\Coorong\Timeseries_Final\ORH_3D\';
...
int = 1;
 ...
 ncfile(int).translate = 1;
  int = int + 1;
 ncfile(int).name = 'R:\Coorong-Local\Netcdf\ORH_Base_3D_20140101_20170101.nc';
 ncfile(int).symbol = {'-';'--'};
 ncfile(int).colour = {'b','b'}; % Surface and Bottom
 ncfile(int).legend = 'MBP 2000';
 ncfile(int).translate = 1;
  int = int + 1;
