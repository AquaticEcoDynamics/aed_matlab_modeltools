...
outputdirectory = 'I:\Erie_plotting\Plots\GR\';
htmloutput = 'F:\Cloudstor\Shared\Aquatic Ecodynamics (AED)\AED_Erie\Model_Results\V9_A4_GR\';
...
%  
 ncfile(2).name = 'I:\Erie_plotting\erie_grandriver_50_AED.nc';
 ncfile(2).symbol = {'-';'--'};
 ...
 ncfile(2).legend = 'GR 50%';
 ncfile(2).translate = 1;

%  
 ncfile(3).name = 'I:\Erie_plotting\erie_grandriver_75_AED.nc';
 ncfile(3).symbol = {'-';'--'};
 ncfile(3).colour = {'k','g'}; % Surface and Bottom
 ncfile(3).legend = 'GR 75%';
