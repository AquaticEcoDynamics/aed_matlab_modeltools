...
plotdepth = {'bottom'};%;'bottom'};%'bottom'}; % Cell with either one or both
...
outputdirectory = 'I:\tfv_009_AED_BIV_Met\Plots\Model 009 A MAG\';
htmloutput = 'F:\Cloudstor\Shared\Aquatic Ecodynamics (AED)\AED_Erie\Model_Results\V8_A1_MAG\';
% ____________________________________________________________Configuration
