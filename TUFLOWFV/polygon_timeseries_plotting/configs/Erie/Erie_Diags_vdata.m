...
def.cAxis(2).value = [];  %'WQ_DIAG_TOT_TP',...
def.cAxis(3).value = [];   %'WQ_DIAG_TOT_TOC',...
def.cAxis(4).value = [];	%'WQ_DIAG_TOT_TSS',...
def.cAxis(5).value = [];  %'WQ_DIAG_TOT_LIGHT',...
...
% Models___________________________________________________________________
 ...
 ncfile(1).name = 'Y:\Erie\tfv_011_Scn00\Output\erie_00_AED_diag.nc';
 ncfile(1).symbol = {'-';'--'};
