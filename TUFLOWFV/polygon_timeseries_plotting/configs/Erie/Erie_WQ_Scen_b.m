...
htmloutput = '~/AED Dropbox/AED_Erie_db/2021/Analysis/ErieMH/Plotting/Erie_TFVAED_Scen1267/bottom/_html/';
outputdirectory = '~/AED Dropbox/AED_Erie_db/2021/Analysis/ErieMH/Plotting/Erie_TFVAED_Scen1267/bottom/';
% ____________________________________________________________Configuration
...
% 
 ncfile(3).name = '/Volumes/T7/Erie/Output.06/erie_06_AED.nc'; 
 ncfile(3).symbol = {'-';'-'};
...
%  ncfile(6).translate = 1;
 ...
 ncfile(4).name = '/Volumes/T7/Erie/Output.02/erie_02_AED.nc'; 
 ncfile(4).symbol = {'-';'-'};
