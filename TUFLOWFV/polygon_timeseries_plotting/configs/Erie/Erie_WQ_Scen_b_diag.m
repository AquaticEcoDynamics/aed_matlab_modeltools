...
htmloutput = '~/AED Dropbox/AED_Erie_db/2021/Analysis/ErieMH/Plotting/Erie_TFVAED_Scen1267/bottom_diags/_html/';
outputdirectory = '~/AED Dropbox/AED_Erie_db/2021/Analysis/ErieMH/Plotting/Erie_TFVAED_Scen1267/bottom_diags/';
% ____________________________________________________________Configuration
...
%  ncfile(6).translate = 1;
 ...
 ncfile(4).name = '/Volumes/T7/Erie/Output.02/erie_02_AED_diag.nc'; 
 ncfile(4).symbol = {'-';'-'};
 ncfile(4).colour = { '#a569bd',[62  39  35]./255};  % Surface and Bottom : RGB to match DEFAULT colour palette
 ncfile(4).legend = '02 50%mus,60%riv';
 ncfile(4).translate = 1;
