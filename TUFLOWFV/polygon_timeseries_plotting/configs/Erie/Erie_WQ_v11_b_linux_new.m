...
isHTML = 0;
htmloutput = '/Projects2/Erie/Plots/Erie_TFVAED_v11e/bottom/_html/';
outputdirectory = '/Projects2/Erie/Plots/Erie_TFVAED_v11e/bottom/';
% ____________________________________________________________Configuration
...
% Models___________________________________________________________________
 ...
 ncfile(1).name = '/Scratch/Erie/tfv_011_Val_a/Output.e/erie_11_e_AED.nc';
 ncfile(1).symbol = {'-';'-'};
 ncfile(1).colour = { '#3498db',[62  39  35]./255};  % Surface and Bottom : RGB to match DEFAULT colour palette
 ncfile(1).legend = 'v11e: new-aed';
