...
isHTML = 0;
htmloutput = 'X:\\Erie/Plots/Erie_TFVAED_v11_BB/bottom/_html/';
outputdirectory = 'X:\\Erie/Plots/Erie_TFVAED_v11_BB/bottom/';
% ____________________________________________________________Configuration
...
% ncfile(2).translate = 1;
 ...
 ncfile(1).name = 'X:\\Erie/v11/Output.b/erie_11_b_AED.nc';
 ncfile(1).symbol = {'-';'-'};
 ncfile(1).colour = {'#1e8449',[62  39  35]./255};  % Surface and Bottom : RGB to match DEFAULT colour palette
 ncfile(1).legend = 'v11b: slough';
 ncfile(1).translate = 1;
