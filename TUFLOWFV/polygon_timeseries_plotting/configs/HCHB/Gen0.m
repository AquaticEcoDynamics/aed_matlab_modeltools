...
yr = 2013;
def.datearray = datenum(yr,07:6:73,1);

%outputdirectory = './Timeseries_Basecase_June/RAW/';
%htmloutput = './Timeseries_Basecase_June/HTML/';
outputdirectory = '/Projects2/CDM/Report_Images/GEN0/RAW/';
htmloutput = '/Projects2/CDM/Report_Images/GEN0/HTML/';
% ____________________________________________________________Configuration
...
% Models___________________________________________________________________
 ncfile(1).name =  '/AED/CIIP/Scenarios/long_term2/CoorongBGC_005_calibration_201305_201903_wq_all.nc';
