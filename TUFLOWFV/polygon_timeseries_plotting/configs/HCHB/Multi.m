...
outputdirectory = '/Projects2/CDM/Report_Images/MULTI/RAW/';
htmloutput = '/Projects2/CDM/Report_Images/MULTI/HTML/';
% ____________________________________________________________Configuration
...
% Models___________________________________________________________________
 ncfile(1).name =  '/Projects2/CDM/hchb_tfvaed_v2_resuspension_z31_newSHP_2022/output_resus/hchb_21901101_20220101_Wave_all.nc';
 ncfile(1).symbol = {'-';'--'};
 ncfile(1).colour = {[82, 94, 117]./255,[82, 94, 117]./255}; % Surface and Bottom
 ncfile(1).legend = 'GEN 1';
 ncfile(1).translate = 1;

 ncfile(2).name =  '/Projects2/CDM/HCHB_scenario_assessment/MER_Coorong_eWater_2022_GEN15_newBC_testing/output_basecase_waves/eWater2021_basecase_t3_wave_all.nc';
 ncfile(2).symbol = {'-';'--'};
 ncfile(2).colour = {[31,120,180]./255,[31,120,180]./255}; % Surface and Bottom
 ncfile(2).legend = 'GEN 1.5';
 ncfile(2).translate = 1;

 ncfile(3).name =  '/Projects2/CDM/HCHB_scenario_assessment/MER_Coorong_eWater_2022_GEN2_0617_Fsed/output_basecase_hd_MIN35sedv4/hchb_Gen2_201707_202201_all.nc';
 ncfile(3).symbol = {'-';'--'};
 ncfile(3).colour = {[120, 147, 138]./255,[120, 147, 138]./255}; % Surface and Bottom
 ncfile(3).legend = 'GEN 2 nWV nSDG';
