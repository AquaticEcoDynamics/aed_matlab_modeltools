...
outputdirectory = '/Projects2/CDM/Report_Images/SDG/RAW/';
htmloutput = '/Projects2/CDM/Report_Images/SDG/HTML/';
% ____________________________________________________________Configuration
...
% Models___________________________________________________________________
 ...
 ncfile(1).legend = 'GEN 2 nSDG';
 ncfile(1).translate = 1;
% % 

 ncfile(2).name =  '/Projects2/CDM/hchb_tfvaed_Gen2.0_sdg/output_basecase_hd/hchb_Gen2_201707_202201_all.nc';
 ncfile(2).symbol = {'-';'--'};
 ncfile(2).colour = {[82, 94, 117]./255,[82, 94, 117]./255}; % Surface and Bottom
 ncfile(2).legend = 'GEN 2 SDG';
