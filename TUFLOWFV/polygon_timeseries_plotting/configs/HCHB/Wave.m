...
outputdirectory = '/Projects2/CDM/Report_Images/WAVES/RAW/';
htmloutput = '/Projects2/CDM/Report_Images/WAVES/HTML/';
% ____________________________________________________________Configuration
...
% % 
 ...
 ncfile(2).name =  '/Projects2/CDM/HCHB_scenario_assessment/MER_Coorong_eWater_2022_GEN15_newBC_testing/output_basecase/eWater2021_basecase_t3_all.nc';
 ncfile(2).symbol = {'-';'--'};
 ncfile(2).colour = {[82, 94, 117]./255,[82, 94, 117]./255}; % Surface and Bottom
 ncfile(2).legend = 'GEN 1.5 nWV';
