...
outputdirectory = '/Volumes/AED/Hawkesbury/HN_Cal_v6_A1a_2014/plotting/Plots_V6/';
htmloutput = ['/Volumes/AED/Hawkesbury/HN_Cal_v6_A1a_2014/plotting/Plots_V6/HTML/'];

% ____________________________________________________________Configuration

% Models___________________________________________________________________

 ncfile(1).name = '/Volumes/AED/Hawkesbury/HN_Cal_v6_A1a_2014/output/HN_Cal_2014_2015_3D_wq_WQ_temp.nc';
 ncfile(1).symbol = {'-';'--'};
 ncfile(1).colour = {[0 96 100]./255,[62 39 35]./255}; % Surface and Bottom % Surface and Bottom
 ncfile(1).legend = 'V6 A1';
 ncfile(1).translate = 1;
  
 ncfile(2).name = '/Volumes/AED/Hawkesbury/HN_Cal_v5_A8/output/HN_Cal_2014_2015_WQ.nc';
 ncfile(2).symbol = {'-';'--'};
