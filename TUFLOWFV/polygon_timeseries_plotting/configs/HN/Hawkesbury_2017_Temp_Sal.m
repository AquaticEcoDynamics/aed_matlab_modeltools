...
outputdirectory = 'J:\Hawkesbury\HN_Cal_v4\Plots\TS1\';
htmloutput = ['J:\Hawkesbury\HN_Cal_v4\Plots\HN_Cal_v4\2017_2018_1\'];

% ____________________________________________________________Configuration

% Models___________________________________________________________________

 ncfile(1).name = 'J:\Hawkesbury\HN_Cal_v4\output\HN_Cal_2017_HYDRO.nc';
