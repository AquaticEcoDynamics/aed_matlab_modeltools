...
def.cAxis(5).value = [0 0.8];           %'WQ_NIT_NIT',...
...
outputdirectory = '~/Dropbox/HawkesburyNepean/HN_Cal_v6/Plots_MH_wq_v/2017/';
...
yr = 2017;
def.datearray = datenum(yr,05:02:20,01);
