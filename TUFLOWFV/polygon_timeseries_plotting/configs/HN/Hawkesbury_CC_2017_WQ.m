...
outputdirectory = '/Projects/Cattai/HN_CC_Cal_v1_A4_2017_2D/Plots_v2_LowDOC_DEM_3D_New/Raw/';
htmloutput = ['/Projects/Cattai/HN_CC_Cal_v1_A4_2017_2D/Plots_v2_LowDOC_DEM_3D_New/HTML/'];

% ____________________________________________________________Configuration

% Models___________________________________________________________________

% ncfile(3).name = '/Projects/Cattai/HN_CC_Cal_v1_A4_2017_2D/output/HN_Cal_2017_2018_2D_wq_DOC_DEM_3D_NS_WQ.nc';
% ncfile(3).symbol = {'-';'--'};
% ncfile(3).colour = {[0 96 100]./255,[62 39 35]./255}; % Surface and Bottom % Surface and Bottom
% ncfile(3).legend = 'LowDOC 3D NS';
% ncfile(3).translate = 1;
%  
ncfile(1).name = '/AED/Hawkesbury/HN_Cal_v7_A3_2017/output/HN_Cal_2017_2018_3D_wq_WQ.nc';
ncfile(1).symbol = {'-';'--'};
...
ncfile(2).name = '/Projects/Cattai/HN_CC_Cal_v1_A4_2017_2D/output/HN_Cal_2017_2018_2D_wq_DOC_DEM_3D_WQ_new.nc';
ncfile(2).symbol = {'-';'--'};
ncfile(2).colour = {'r','b'}; % Surface and Bottom
ncfile(2).legend = 'AED';
ncfile(2).translate = 1;

%ncfile(3).name = '/Projects/Cattai/HN_CC_Cal_v1_A4_2017_2D/output/HN_OLD.nc';
%ncfile(3).symbol = {'-';'--'};
%ncfile(3).colour = {'g','b'}; % Surface and Bottom
%ncfile(3).legend = 'OLD';
%ncfile(3).translate = 1;
 
%ncfile(3).name = '/Projects/Cattai/HN_CC_Cal_v1_A1_2017/output/HN_Cal_2017_2018_3D_wq_WQ.nc';
%ncfile(3).symbol = {'-';'--'};
