...
varname = {...
 ...
 def.cAxis(5).value = [0 30];           %'WQ_DIAG_PHY_TCHLA',...
...
outputdirectory = '/Projects/Cattai/Report_V2/Polygon/Cattai_2014_2015/RAW/';
htmloutput = ['/Projects/Cattai/Report_V2/Polygon/Cattai_2014_2015/HTML/'];
