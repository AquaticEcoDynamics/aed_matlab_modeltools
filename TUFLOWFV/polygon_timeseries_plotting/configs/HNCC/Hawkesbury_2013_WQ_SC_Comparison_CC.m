...
%
%polygon_file = '/Users/00042030/Sims/Hawkesbury/matlab/modeltools/gis/Hawkesbury_Cattai_Zones.shp';

fielddata_matfile = '../../../Hawkesbury/matlab/modeltools/matfiles/hawkesbury_all.mat';
fielddata = 'hawkesbury_all';

polygon_file = '../../../Hawkesbury/matlab/modeltools/gis/Hawkesbury_Cattai_Zones.shp';
varname = {...
     'WQ_OXY_OXY',...
     'WQ_NIT_AMM',...
     'WQ_NIT_NIT',...
 ...
 def.cAxis(5).value = [0 50];           %'WQ_DIAG_PHY_TCHLA',...
...
outputdirectory = '/Projects/Cattai/Report_V3/Polygon/HN_Comparison_2013/RAW/';
htmloutput = ['/Projects/Cattai/Report_V3/Polygon/HN_Comparison_2013/HTML/'];

% ____________________________________________________________Configuration

% Models___________________________________________________________________

 ncfile(1).name = '/Projects2/Cattai/HN_CC_Cal_v1_A7_Scenarios/output/HN_Cal_2013_2016_3D_wq_Baseline_Validation_WQ_bak.nc';
...
%  
  ncfile(2).name = '/AED/Hawkesbury/HN_Cal_v7_A3_2013/output_1314/HN_Cal_2013_2014_3D_wq_subtype1_WQ.nc'; 
  ncfile(2).symbol = {'-';'--'};
  ncfile(2).colour = {[0 0 0],[0.0509803921568627         0.215686274509804         0.968627450980392]}; % Surface and Bottom
  ncfile(2).legend = 'HN 00';
  ncfile(2).translate = 1;
 
  %ncfile(3).name = '/Projects2/Cattai/HN_CC_Cal_v1_A6_Scenarios/output_bak/HN_Cal_2013_2016_3D_wq_Impact_WQ.nc'; 
  %ncfile(3).symbol = {'-';'--'};
