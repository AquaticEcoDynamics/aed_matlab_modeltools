...
outputdirectory = '/Projects/Cattai/Report_V3/Validation/Polygon/HN_Validation/RAW/';
htmloutput = ['/Projects/Cattai/Report_V3/Validation/Polygon/HN_Validation/HTML/'];
