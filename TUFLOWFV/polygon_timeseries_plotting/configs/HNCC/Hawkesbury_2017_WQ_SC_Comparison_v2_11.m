...
outputdirectory = '/Projects/Cattai/Report_V2/Polygon/HN_Comparison_2017_v2_11/RAW/';
htmloutput = ['/Projects/Cattai/Report_V2/Polygon/HN_Comparison_2017_v2_11/HTML/'];

% ____________________________________________________________Configuration

% Models___________________________________________________________________

 ncfile(1).name = '/Projects2/Cattai/HN_CC_Cal_v1_A4_2017_2D_TESTRUN/output/HN_Cal_2017_2018_2D_wq_DOC_DEM_3D_1_WQ.nc';
...
%  
  ...
  %
  ncfile(2).name = '/Projects2/Cattai/HN_Cal_v7_A3_2017_TESTRUN/output/HN_Cal_2017_2018_3D_wq_1_WQ.nc'; 
  ncfile(2).symbol = {'-';'--'};
  ncfile(2).colour = {'g',[0.0509803921568627         0.215686274509804         0.968627450980392]}; % Surface and Bottom
  ncfile(2).legend = 'Baselne 2021 AED MET';
  ncfile(2).translate = 1;
...
yr = 2017;
def.datearray = datenum(yr,05,01:01:10);
