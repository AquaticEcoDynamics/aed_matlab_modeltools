...
def.cAxis(1).value = [0 50];    		%'WQ_NCS_SS1',...
...
def.cAxis(19).value = [0 100];           %'WQ_DIAG_PHY_TPHYS',...
def.cAxis(20).value = [0 3];           %'WQ_DIAG_TOT_TN',...
def.cAxis(21).value = [0 0.3];           %'WQ_DIAG_TOT_TP',...
def.cAxis(22).value = [0 15];           %'WQ_DIAG_TOT_TOC',...
def.cAxis(23).value = [0 50];           %'WQ_DIAG_TOT_TSS',...
def.cAxis(24).value = [0 50];         %'WQ_DIAG_TOT_TURBIDITY',...
...
% Models___________________________________________________________________
 ...
 ncfile(1).name = 'I:\Hawkesbury\HN_Cal_v4\output\HN_Cal_2017_WQ.nc';
