...
outputdirectory = 'F:\Cloudstor\Shared\Aquatic Ecodynamics (AED)\AED_Peel\4_Simulations\PeelHarveyCatchmentModelResults\Nectar\Peel_v11\1979\Regions\';
% ____________________________________________________________Configuration

% Models___________________________________________________________________


 ncfile(1).name = 'Z:\run_1979_1981.nc';
 ncfile(1).symbol = {'-';'--'};
...
yr = 1979;
def.datearray = datenum(yr,04:04:28,01);
