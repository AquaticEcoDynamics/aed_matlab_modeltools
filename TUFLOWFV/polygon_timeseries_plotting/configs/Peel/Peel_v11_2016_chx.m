...
outputdirectory = 'F:\Cloudstor\Shared\Aquatic Ecodynamics (AED)\AED_Peel\4_Simulations\PeelHarveyCatchmentModelResults\Nectar\Peel_v11\2016 Crash Chx\Regions\';
% ____________________________________________________________Configuration
...
%   ncfile(3).name = 'Z:\PEEL\2016_Local\run_2016_nov_2.nc';
%  ncfile(3).symbol = {'-';'--'};
...
yr = 2016;
def.datearray = datenum(yr,10,28:02:36);
