...
outputdirectory = 'F:\OneDrive - The University of Western Australia\Peel\Nectar\Peel_v11\Historical Final\1980_1983/Regions_prefab/';
% ____________________________________________________________Configuration

% Models___________________________________________________________________


 ncfile(1).name = 'Y:\Peel Final Report\Processed v11\run_1980_1981\';
 ncfile(1).symbol = {'-';'--'};
 ...
 ncfile(2).name = 'Y:\Peel Final Report\Processed v11\run_1981_1983\';
 ncfile(2).symbol = {'-';'--'};
