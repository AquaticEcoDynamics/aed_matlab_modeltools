...
outputdirectory = 'F:\OneDrive - The University of Western Australia\Peel\Nectar\Peel_v11/Historical Final\2012_2014/Regions_prefab/';
% ____________________________________________________________Configuration

% Models___________________________________________________________________


 ncfile(1).name = 'Y:\Peel Final Report\Processed v11\run_2013_2015\';
 ncfile(1).symbol = {'-';'--'};
 ...
 ncfile(2).name = 'Y:\Peel Final Report\Processed v11\run_2014_2015\';
 ncfile(2).symbol = {'-';'--'};
