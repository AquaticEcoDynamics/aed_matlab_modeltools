...
def.cAxis(4).value = [0 15]; 	%'WQ_DIAG_TOT_TN',...
def.cAxis(5).value = [0 1]; 	%'WQ_DIAG_TOT_TP',...
def.cAxis(6).value = [0 35]; 	%'WQ_DIAG_PHY_TCHLA',...
def.cAxis(7).value = [0 200]; 	%'WQ_DIAG_TOT_TURBIDITY',...
def.cAxis(8).value = [0 500]; 	%'WQ_DIAG_MALG_TMALG',...
def.cAxis(9).value = [0 1]; 	%'WQ_NIT_AMM',...
...
outputdirectory = 'F:\OneDrive - The University of Western Australia\Peel\Nectar\Peel_v11/Historical Final\2016_2018/Regions_prefab/';
% ____________________________________________________________Configuration

% Models___________________________________________________________________


 ncfile(1).name = 'T:\Processed\run_2016_2018_local\';
 ncfile(1).symbol = {'-';'--'};
 ...
 ncfile(2).name = 'T:\Processed\run_2016_nov_2\';
 ncfile(2).symbol = {'-';'--'};
...
%  ncfile(3).name = 'Y:\Peel Final Report\Processed v11\run_2017_2018\';
%  ncfile(3).symbol = {'-';'--'};
