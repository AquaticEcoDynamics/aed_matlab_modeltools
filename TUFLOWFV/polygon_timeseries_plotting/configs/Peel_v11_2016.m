...
outputdirectory = 'F:\Cloudstor\Shared\Aquatic Ecodynamics (AED)\AED_Peel\4_Simulations\PeelHarveyCatchmentModelResults\Nectar\Peel_v11\2016 Crash\Regions\';
% ____________________________________________________________Configuration
...
%  
 ncfile(2).name = 'Z:\PEEL\2016_Local\run_2016_nov.nc';
 ncfile(2).symbol = {'-';'--'};
