...
polygon_file = 'GIS/peel_polygons.shp';
...
outputdirectory = 'F:\Cloudstor\Shared\Aquatic Ecodynamics (AED)\AED_Peel\4_Simulations\PeelHarveyCatchmentModelResults\Nectar\Peel_v11\2016\Regions\';
% ____________________________________________________________Configuration

% Models___________________________________________________________________


 ncfile(1).name = 'K:\Peel_Scenarios\Reruns\run_2016_2018.nc';
 ncfile(1).symbol = {'-';'--'};
...
yr = 2016;
def.datearray = datenum(yr,04:02:12,01);
