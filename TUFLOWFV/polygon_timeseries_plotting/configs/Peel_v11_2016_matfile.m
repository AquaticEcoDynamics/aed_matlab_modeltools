...
outputdirectory = 'F:\OneDrive - The University of Western Australia\Peel\Nectar\Peel_v11\2016 Joined\Regions\';
% ____________________________________________________________Configuration

% Models___________________________________________________________________


 ncfile(1).name = 'T:\Processed\run_2016_2018\';
 ncfile(1).symbol = {'-';'--'};
...
yr = 2016;
def.datearray = datenum(yr,04:02:20,01);
