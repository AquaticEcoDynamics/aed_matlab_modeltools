...
def.cAxis(2).value = [0 1];            %'SAL',...




polygon_file = 'GIS/HN/SC_Zones.shp';
...
outputdirectory = 'G:\Work Stuff\South_Creek\Test1\';
htmloutput = ['D:\Cloud\Cloudstor\Shared\Aquatic Ecodynamics (AED)\AED_Hawkesbury\Model_Results\South_Creek\2017_2018\'];

% ____________________________________________________________Configuration

% Models___________________________________________________________________

 ncfile(1).name = 'G:\Work Stuff\SC_Cal_2017_HYDRO.nc';
...
yr = 2017;
def.datearray = datenum(yr,01:03:12,01);
