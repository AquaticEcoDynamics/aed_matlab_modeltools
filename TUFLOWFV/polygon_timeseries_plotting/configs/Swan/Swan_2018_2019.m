...
outputdirectory = ['R:\SCERM\Plotting Output\',rgh,'_nCANNING\'];
htmloutput = ['F:\Cloudstor\Shared\Aquatic Ecodynamics (AED)\AED_Swan_BB\V4_B2_Multiyear_nCanning\',rgh,'\'];
...
%nc file loc changed%
ncfile(1).name = ['Q:\Busch\Studysites\Swan\Simulations\SCERM_NoCanning\Output/swan_',rgh,'_ALL.nc'];% change this to the nc file loc
