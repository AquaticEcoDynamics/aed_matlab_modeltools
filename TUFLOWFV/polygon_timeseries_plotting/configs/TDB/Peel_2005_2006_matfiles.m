...
outputdirectory = 'F:\OneDrive - The University of Western Australia\Peel\Nectar\Peel_v11/Historical Final\2004_2007/Regions_prefab/';
% ____________________________________________________________Configuration

% Models___________________________________________________________________


 ncfile(1).name = 'Y:\Peel Final Report\Processed v11\run_2005_2007\';
 ncfile(1).symbol = {'-';'--'};
 ...
 ncfile(2).name = 'Y:\Peel Final Report\Processed v11\run_2006_2007\';
 ncfile(2).symbol = {'-';'--'};
