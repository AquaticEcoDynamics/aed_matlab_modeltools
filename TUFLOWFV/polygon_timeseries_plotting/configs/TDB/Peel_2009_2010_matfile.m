...
def.cAxis(5).value = [0 5]; 	%'WQ_DIAG_TOT_TP',...
def.cAxis(6).value = [0 35]; 	%'WQ_DIAG_PHY_TCHLA',...
def.cAxis(7).value = [0 500]; 	%'WQ_DIAG_TOT_TURBIDITY',...
...
outputdirectory = 'F:\OneDrive - The University of Western Australia\Peel\Nectar\Peel_v11/Historical Final\2007_2009/Regions_prefab/';
% ____________________________________________________________Configuration

% Models___________________________________________________________________


 ncfile(1).name = 'Y:\Peel Final Report\Processed v11\run_2008_2010\';
 ncfile(1).symbol = {'-';'--'};
...
%  ncfile(2).name = 'Y:\Peel Final Report\Processed v11\run_2007_2009_rst';
%  ncfile(2).symbol = {'-';'--'};
