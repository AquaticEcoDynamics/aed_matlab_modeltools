function plottfv_averaged_4_panel_coorong_sheet_inserts_lims_2_combo_f(ncfile,outdir,scenario,year)
...
% 
% outdir = 'D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\009_2015_rolling_0SC_0B\Sheets\2_flower_new\';
...
axes('position',[ 0.29 0.0  1.0 1.0]);
    ...
    text(0.41,0.95,'HSI (Flower)','Units','Normalized','fontsize',12);
...
saveas(gcf,[outdir,'HSI_flower.png']);
save([outdir,'HSI_flower.mat'],'min_cdata','-mat');

export_area([outdir,'HSI_flower.csv'],min_cdata,Area);
