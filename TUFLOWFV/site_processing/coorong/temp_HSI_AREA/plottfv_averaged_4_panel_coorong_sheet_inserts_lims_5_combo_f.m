function plottfv_averaged_4_panel_coorong_sheet_inserts_lims_5_combo_f(ncfile,outdir,scenario,year);
...
% 
% outdir = 'D:\Cloud\Dropbox\Data_Lowerlakes\Illustrator Processing\009_2015_rolling_0SC_0B\Sheets\5_sprout_new\';
...
var(1).cax = [0 1];
var(1).title = ' f(S)';
var(1).SaveName = '5_fsal';
var(1).daterange = [datenum(yr,04,01) (datenum(yr,04,01)+windowLength) ]; %>= 1 < 2

var(2).name = 'WQ_DIAG_HAB_RUPPIA_HSI_FTEM_5';
var(2).cax = [0 1];
var(2).title = ' f(T)';
var(2).SaveName = '5_ftem';
var(2).daterange = [datenum(yr,04,01) (datenum(yr,04,01)+windowLength) ]; %>= 1 < 2

var(3).name = 'WQ_DIAG_HAB_RUPPIA_HSI_FLGT_5';
var(3).cax = [0 1];
var(3).title = ' f(I)';
var(3).SaveName = '5_flgt';
var(3).daterange = [datenum(yr,04,01) (datenum(yr,04,01)+windowLength) ]; %>= 1 < 2

var(4).name = 'WQ_DIAG_HAB_RUPPIA_HSI_FALG_5';
var(4).cax = [0 1];
var(4).title = ' f(FA)';
var(4).SaveName = '5_falg';
var(4).daterange = [datenum(yr,04,01) (datenum(yr,04,01)+windowLength) ]; %>= 1 < 2

var(5).name = 'WQ_DIAG_HAB_RUPPIA_HSI_FDEP_5';
var(5).cax = [0 1];
var(5).title = ' f(WL)';
var(5).SaveName = '5_fdep';
...
axes('position',[ 0.29 0.0  1.0 1.0]);
    ...
    text(0.41,0.95,'HSI (Sprout)','Units','Normalized','fontsize',12);
...
saveas(gcf,[outdir,'HSI_sprout.png']);
save([outdir,'HSI_sprout.mat'],'min_cdata','-mat');

export_area([outdir,'HSI_sprout.csv'],min_cdata,Area);
