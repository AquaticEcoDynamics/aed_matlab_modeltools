function plottfv_averaged_4_panel_coorong_sheet_inserts_malg_f(ncfile,outdir,year)
...
% axes('position',[ 0.15 0.0  1.0 1.0]);
...
%     camroll(-25)
% 
%     text(0.40,0.95,'Ulva HSI','Units','Normalized','fontsize',12);
...
axes('position',[ 0.25 0.0  1.0 1.0]);
    ...
    text(0.40,0.95,'Ulva Biomass','Units','Normalized','fontsize',12);
