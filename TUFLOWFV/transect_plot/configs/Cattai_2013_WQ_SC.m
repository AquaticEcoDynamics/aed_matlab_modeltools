...
points_file = '../../../Hawkesbury/matlab/modeltools/gis/Cattai_Upper_Transect.shp';
...
%def.cAxis(1).value = [0 150];    		%'TN_TP',...
 ...
 def.cAxis(5).value = [0 5];           %'WQ_DIAG_PHY_TCHLA',...
...
outputdirectory = '/Projects/Cattai/Report/Transect/CC_Upper_2013-2015/RAW/';
htmloutput = ['/Projects/Cattai/Report/Transect/CC_Upper_2013-2015/HTML/'];

% ____________________________________________________________Configuration

% Models___________________________________________________________________

 ncfile(1).name = '/Projects2/Cattai/cattai_tfv_aed_v4_scenarios/output/CC_Cal_2013_2015_baseline.nc';
%  ncfile(1).tfv = 'I:/Hawkesbury/HN_Cal_v3_noIC/output/HN_Cal_2013_HYDRO.nc';
 ncfile(1).legend = 'Baseline';
%  
  ncfile(2).name = '/Projects2/Cattai/cattai_tfv_aed_v4_scenarios/output/CC_Cal_2013_2015_background.nc'; 
  ncfile(2).legend = 'Background';
 
  ncfile(3).name = '/Projects2/Cattai/cattai_tfv_aed_v4_scenarios/output/CC_Cal_2013_2015_impact.nc'; 
