...
def.cAxis(3).value = [0 200];         %'SAL',...
def.cAxis(4).value = [0 200];         %'SAL',...
def.cAxis(5).value = [0 400];         %'SAL',...
def.cAxis(6).value = [0 400];         %'SAL',...
def.cAxis(7).value = [0 400];         %'SAL',...
def.cAxis(8).value = [0 400];         %'SAL',...
def.cAxis(9).value = [0 80];         %'SAL',...

def.cAxis(10).value = [0 100];    		%'WQ_NCS_SS1',...
def.cAxis(11).value = [0 12.5];            %'WQ_OXY_OXY',...
def.cAxis(12).value = [0 10];            %'WQ_SIL_RSI',...
def.cAxis(13).value = [0 0.25];	        %'WQ_NIT_AMM',...
def.cAxis(14).value = [0 1];           %'WQ_NIT_NIT',...
def.cAxis(15).value = [0 0.1];             %'WQ_PHS_FRP',...
def.cAxis(16).value = [0 0.07];             %'WQ_PHS_FRP_ADS',...
def.cAxis(17).value = [0 15];           %'WQ_OGM_DOC',...
def.cAxis(18).value = [0 2];            %'WQ_OGM_POC',...
def.cAxis(19).value = [0 0.65];            %'WQ_OGM_DON',...
def.cAxis(20).value = [0 1.5];            %'WQ_OGM_PON',...
def.cAxis(21).value = [0 0.05];          %'WQ_OGM_DOP',...
def.cAxis(22).value = [0 0.15];          %'WQ_OGM_POP',...
def.cAxis(23).value = [0 75];          %'WQ_PHY_GRN',...
def.cAxis(24).value = [0 50];            %'WQ_PHY_BGA',...
def.cAxis(25).value = [0 75];          %'WQ_PHY_FDIAT',...
def.cAxis(26).value = [0 20];          %'WQ_PHY_MDIAT',...
def.cAxis(27).value = [0 135];           %'WQ_TRC_AGE',...
def.cAxis(28).value = [0 60];           %'WQ_DIAG_PHY_TCHLA',...
def.cAxis(29).value = [0 3];           %'WQ_DIAG_TOT_TN',...
def.cAxis(30).value = [0 0.3];           %'WQ_DIAG_TOT_TP',...
def.cAxis(31).value = [0 15];           %'WQ_DIAG_TOT_TOC',...
def.cAxis(32).value = [0 100];           %'WQ_DIAG_TOT_TSS',...
def.cAxis(33).value = [0 150];         %'WQ_DIAG_TOT_TURBIDITY',...
def.cAxis(34).value = [5 40];           %'Temp',...
def.cAxis(35).value = [0 400];         %'SAL',...
...
outputdirectory = '/Volumes/AED/Hawkesbury/HN_Cal_v6_A1b_2012/plotting/Plots_V6/transect/2012/';
htmloutput = ['/Users/00042030/Dropbox/HN FV AED2_SWC_incoming/V6/Plots_MH_path/transect/2012/html/'];
