...
def.cAxis(1).value = [0 500];            %'WQ_OXY_OXY',...
def.cAxis(2).value = [0 500];            %'WQ_OXY_OXY',...
def.cAxis(3).value = [0 500];            %'WQ_OXY_OXY',...
def.cAxis(4).value = [0 500];            %'WQ_OXY_OXY',...
...
% def.cAxis(15).value = [0 1];            %'HSI_CYANO
...
% Models___________________________________________________________________
 ...
 ncfile(1).name = '/Volumes/AED/Hawkesbury/HN_Cal_v6_A1b_2012/output/HN_Cal_2012_2013_3D_pt_WQ.nc';
