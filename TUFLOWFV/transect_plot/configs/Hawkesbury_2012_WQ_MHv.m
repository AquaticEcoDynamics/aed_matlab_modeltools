...
def.cAxis(2).value = [0 0.1];           %'WQ_PHS_FRP',...
def.cAxis(3).value = [0 60];           %'WQ_DIAG_PHY_TCHLA',...
def.cAxis(4).value = [0 3];            %'WQ_DIAG_TOT_TN',...
def.cAxis(5).value = [0 0.3];          %'WQ_DIAG_TOT_TP',...
def.cAxis(6).value = [0 100];          %'WQ_DIAG_TOT_TSS',...
def.cAxis(7).value = [0 150];          %'WQ_DIAG_TOT_TURBIDITY',...
def.cAxis(8).value = [5 40];           %'Temp',...
def.cAxis(9).value = [0 1.3];            %'HSI_CYANO
def.cAxis(10).value = [0 0.25];	        %'WQ_NIT_AMM',...
def.cAxis(11).value = [0 1.2];           %'WQ_NIT_NIT',...
def.cAxis(12).value = [0 40];           %'SAL',...
def.cAxis(13).value = [5 40];           %'TN:TP',...
...
outputdirectory = '~/Dropbox/HawkesburyNepean/HN_Cal_v6/Plots_MH_wq_v/2012/transect/' ;
htmloutput = ['~/Dropbox/HawkesburyNepean/HN_Cal_v6/Plots_MH_wq_v/2012/html/'];
...
% Models___________________________________________________________________
 ...
 ncfile(1).name = '/Volumes/AED/Hawkesbury/HN_Cal_v6_A1a_2012/output/HN_Cal_2012_2013_3D_wq_WQ.nc';
