...
outputdirectory = 'F:\Temp_Plots\Hawkesbury\HN_Cal_v5\Plots_V5_A61111\';
htmloutput = ['F:\Cloudstor\Shared\Aquatic Ecodynamics (AED)\AED_Hawkesbury\Model_Results\HN_Cal_v5_A7\2017_2018\Transect-Surface-COMP\'];

% ____________________________________________________________Configuration

% Models___________________________________________________________________

 ncfile(1).name = 'P:\Hawkesbury\HN_Cal_v5\output\HN_Cal_2017_2018_WQ.nc';
 ncfile(1).legend = 'V5_A7';
%
