...
outputdirectory = ['F:\Cloudstor\Shared\Aquatic Ecodynamics (AED)\AED_Swan_BB\SCERM_v6\V6_A3\2015_2016_report\Transect_Surface_Scenarios_Canning\RAW\'];
htmloutput = ['F:\Cloudstor\Shared\Aquatic Ecodynamics (AED)\AED_Swan_BB\SCERM_v6\V6_A3\2015_2016_report\Transect_Surface_Scenarios_Canning\HTML\'];
...
%
ncfile(2).name = ['N:\SCERM\SCERM_v6_A3\Output_plt/SCERM44_2015_2016_Capped_ALL.nc'];% change this to the nc file loc
ncfile(2).legend = 'Capped';
