...
outputdirectory = ['F:\Cloudstor\Shared\Aquatic Ecodynamics (AED)\AED_Swan_BB\SCERM_v6\V6_A3\2015_2016_report\StackedArea_SCERM44_TCHLA_Canning_Dry\RAW\'];
htmloutput = ['F:\Cloudstor\Shared\Aquatic Ecodynamics (AED)\AED_Swan_BB\SCERM_v6\V6_A3\2015_2016_report\StackedArea_SCERM44_TCHLA_Canning_Dry\HTML\'];

% ____________________________________________________________Configuration

% Models___________________________________________________________________

ncfile(1).name = ['N:\SCERM\SCERM_v6_A3\Output_plt/SCERM44_2015_2016_Dry_ALL.nc'];% change this to the nc file loc
ncfile(1).legend = 'SCERM 44 Dry';%
