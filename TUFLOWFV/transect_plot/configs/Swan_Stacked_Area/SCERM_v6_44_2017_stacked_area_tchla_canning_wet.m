...
outputdirectory = ['F:\Cloudstor\Shared\Aquatic Ecodynamics (AED)\AED_Swan_BB\SCERM_v6\V6_A3\2017_2018_report\StackedArea_SCERM44_TCHLA_Canning_Wet\RAW\'];
htmloutput = ['F:\Cloudstor\Shared\Aquatic Ecodynamics (AED)\AED_Swan_BB\SCERM_v6\V6_A3\2017_2018_report\StackedArea_SCERM44_TCHLA_Canning_Wet\HTML\'];

% ____________________________________________________________Configuration

% Models___________________________________________________________________

ncfile(1).name = ['N:\SCERM\SCERM_v6_A3\Output_plt/SCERM44_2017_2018_Wet_ALL.nc'];% change this to the nc file loc
ncfile(1).legend = 'SCERM 44 Wet';%
