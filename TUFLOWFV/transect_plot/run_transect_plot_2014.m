...
theStruct.ncfile = 'X:\Work\HN_Cal_v5\output\HN_Cal_2014_2015_2D_WQ.nc';
...
theStruct.varname = 'TN_TP';
theStruct.ylab = 'TN:TP (mg/L)';
theStruct.conv = 1;
...
theStruct.outdir = 'D:\Cloud\Cloudstor\Shared\Aquatic Ecodynamics (AED)\AED_Hawkesbury\Model_Results\HN_Cal_v5_A4\2014\Transect\';
...
for i =  7:01:16
    theStruct.daterange = datenum(2014,i:i+1,01);
